...
// import { AccessoriesSchema, AccessoryImage, IAccessoriesInput } from "./AccessoriesSchema";
...
//   const [featuredImage, setFeaturedImage] = useState<ExistingImage | null>(null);
...
//       try {
//         const accessory = await AccessoriesService.fetchSingleAccessoryWithImages(id as string);
...
//         const featuredImg = images.find((img: AccessoryImage) => img.Is_Featured__c);
...
//                 <div className="relative w-full h-[358px] mb-6" onClick={()=>setShowPreview(true)}>
//                   <img
//                     src={
...
//                         onClick={() => setAsFeaturedImage(previewImage.index, previewImage.type)}
//                       >
